...
const REVIEWS = [
  {
    name: "??*",
    area: "?�울 마포�?,
    text: "주방 문짝???�아???�체 교체?�까 ?�는?? 문짝�?바꾸?????�크?� 같아?? 비용??1/5 ?��?!",
    rating: 5,
  },
  {
    name: "??*",
    area: "경기 ?�원??,
    text: "?�상???�하??걸로 골랐?�데 기존 ?�크?�???�벽?�게 맞아?? ?�만족?�니??",
    rating: 5,
  },
  {
    name: "??*",
    area: "?�천 ?�동�?,
    text: "?�래???�파?�라 ?�크?�가 ?�렇�?변?�는?? 문짝 교체?�니 주방???�해졌어??",
    rating: 5,
  },
  {
    name: "??*",
    area: "?�울 강남�?,
    text: "?�공 ?�간??짧고, 주방 ?�용 �??�는 기간??거의 ?�어??좋았?�니??",
    rating: 5,
  },
];
...
const FAQ = [
  {
    q: "문짝�?교체?�도 ?�것처럼 ?�나??",
    a: "?? ?�크?� 본체(캐비??가 멀쩡하�?문짝�?교체?�도 ???�크?�처럼 바뀝니?? ?�상·?�질???�하???��??�택 가?�합?�다.",
  },
  {
    q: "?�체 교체 ?��?비용?� ?�마???�약?�나??",
    a: "보통 ?�체 교체??1/3~1/5 ?��??�니?? ?�장 ?�태???�라 ?�르�? ?�진 보내주시�??�확??비용 범위�??�내?�립?�다.",
  },
  {
    q: "?�공 ?�간?� ?�마??걸리?�요?",
    a: "문짝 교체 기�? ??1~2?�간 ?�요?�니?? ?�일 ?�공 ?�료?�며, 바로 ?�용 가?�합?�다.",
  },
  {
    q: "기존 ?�크?� ?�상�?맞출 ???�나??",
    a: "?�양???�상·?�턴 ?�플??보유?�고 ?�어 기존 주방 ?�테리어??맞게 ?�택?�실 ???�습?�다.",
  },
  {
    q: "A/S???�떻�??�나??",
    a: "?�공 ??3?�간 무상 A/S�??�공?�니?? 문짝 ?�뜸, 경첩 문제 ??무상?�로 ?�시공해?�립?�다.",
  },
];

const EXTRAS = [
  { icon: "?��", title: "경첩 교체", desc: "문짝 교체 ??경첩???�것?�로 교체" },
  { icon: "?��", title: "?��???물먹??, desc: "?�기�??�한 부?�?�·�????�리" },
  {
    icon: "?��",
    title: "?��???처짐",
    desc: "?��???처짐·??증상 ?�께 ?�리 가??,
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <FadeIn delay={200}>
            <div className="grid grid-cols-2 gap-3 md:gap-5">
              {[
                { img: "/images/door/before-after-1.jpg", label: "?�공 ?? },
                { img: "/images/door/before-after-2.jpg", label: "?�공 ?? },
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <FadeIn delay={120}>
            <div className="mt-10 grid grid-cols-2 gap-0 overflow-hidden rounded-2xl border border-[#e0e8f5]">
              ...
              {[
                ...
                { a: "~E1 ?�벨 보드", b: "친환�?E0~ ?�벨 보드" },
                { a: "A/S 1???�는 ?�음", b: "무상 A/S 3??보장" },
              ].map((row, i) => (
      ...
      <section
        ...
        <FadeIn>
          ...
          <p className="text-[50px] font-black tracking-tight md:text-[80px]">
            <span style={{ color: "#ffffff" }}>?�별 ?�비???�나 ??</span>
          </p>
        ...
        <div className="mx-auto max-w-3xl">
          <FadeIn>
            ...
            <h2 className="text-[30px] font-black leading-[1.4] md:text-[45px]">
              ?�런 ?�태?�면
              <br />
              <span className="text-[#e53e3e]">?�어 교체 ?�기?�니??/span>
            </h2>
          </FadeIn>
          <FadeIn delay={120}>
              ...
              {[
                {
                  ...
                  title: "문짝 변?�·누?�게",
                  desc: "?�월???�한 변?�으�?n주방???�두?�진 ?�태",
                },
                {
                  img: "/images/door/symptom-2.jpg",
                  title: "?�름 벗겨�?,
                  desc: "문짝 ?�면 ?�름??n?�뜨거나 벗겨�??�태",
                },
                {
      ...
      <section
        ...
        <FadeIn>
          <h2 className="text-[24px] font-black leading-[1.4] md:text-[36px]">
            ?�크?� 문짝 리폼
            <br />
            <span style={{ color: "#ffe066" }}>가???�?�하�?/span> 주방??
            바꾸??방법
          </h2>
          <p
          ...
          <div className="mx-auto mt-7 flex flex-wrap justify-center gap-2">
            {["고급 ?�름", "100+ ?�상", "?�일 ?�공", "3??A/S"].map((badge) => (
              <span
                key={badge}
